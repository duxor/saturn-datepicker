(function (global, factory) {
    ...
    (global = global || self, factory(global['saturn-datepicker'] = {}, global.ng.cdk.platform, global.ng.core, global.rxjs, global.ng.cdk.a11y, global.ng.cdk.overlay, global.ng.cdk.portal, global.ng.common, global.ng.material.button, global.ng.material.dialog, global.ng.cdk.keycodes, global.ng.cdk.bidi, global.rxjs.operators, global.ng.cdk.coercion, global.ng.material.core, global.ng.animations, global.ng.forms, global.ng.material['form-field'], global.ng.material.input));
}(this, (function (exports, platform, core, rxjs, a11y, overlay, portal, common, button, dialog, keycodes, bidi, operators, coercion, core$1, animations, forms, formField, input) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NativeDateAdapter = /** @class */ (function (_super) {
        ...
        NativeDateAdapter = __decorate([
            core.Injectable(),
            __param(0, core.Optional()), __param(0, core.Inject(MAT_DATE_LOCALE))
        ], NativeDateAdapter);
    ...
    var SatDatepickerIntl = /** @class */ (function () {
        ...
        SatDatepickerIntl.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function SatDatepickerIntl_Factory() { return new SatDatepickerIntl(); }, token: SatDatepickerIntl, providedIn: "root" });
    ...
    var SatMonthView = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild(SatCalendarBody, { static: false })
        ...
        SatMonthView = __decorate([
            ...
            __param(1, core.Optional()), __param(1, core.Inject(MAT_DATE_FORMATS)),
    ...
    var SatCalendarHeader = /** @class */ (function () {
        ...
        SatCalendarHeader.ctorParameters = function () { return [
            ...
            { type: SatCalendar, decorators: [{ type: core.Inject, args: [core.forwardRef(function () { return SatCalendar; }),] }] },
            { type: DateAdapter, decorators: [{ type: core.Optional }] },
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [MAT_DATE_FORMATS,] }] },
            { type: core.ChangeDetectorRef }
        ]; };
        SatCalendarHeader = __decorate([
            ...
            __param(1, core.Inject(core.forwardRef(function () { return SatCalendar; }))),
            __param(2, core.Optional()),
            __param(3, core.Optional()), __param(3, core.Inject(MAT_DATE_FORMATS))
        ], SatCalendarHeader);
    ...
    var SatCalendar = /** @class */ (function () {
        function SatCalendar(_intl, _dateAdapter, _dateFormats, _changeDetectorRef) {
            ...
            this.beginDateSelectedChange = new core.EventEmitter();
            /**
        ...
        __decorate([
            core.ViewChild(SatMonthView, { static: false })
        ], SatCalendar.prototype, "monthView", void 0);
        __decorate([
            core.ViewChild(SatYearView, { static: false })
        ], SatCalendar.prototype, "yearView", void 0);
        __decorate([
            core.ViewChild(SatMultiYearView, { static: false })
        ...
        SatCalendar = __decorate([
            ...
            __param(1, core.Optional()),
            __param(2, core.Optional()), __param(2, core.Inject(MAT_DATE_FORMATS))
        ], SatCalendar);
        return SatCalendar;
    }());
    ...
    var MAT_DATEPICKER_SCROLL_STRATEGY = new core.InjectionToken('sat-datepicker-scroll-strategy');
    /** @docs-private */
    ...
    var _SatDatepickerContentMixinBase = core$1.mixinColor(SatDatepickerContentBase);
    /**
    ...
    var SatDatepickerContent = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild(SatCalendar, { static: false })
    ...
    var SatDatepicker = /** @class */ (function () {
        ...
        SatDatepicker = __decorate([
            ...
            __param(4, core.Inject(MAT_DATEPICKER_SCROLL_STRATEGY)),
    ...
    var MAT_DATEPICKER_VALUE_ACCESSOR = {
        ...
        useExisting: core.forwardRef(function () { return SatDatepickerInput; }),
        multi: true
    };
    /** @docs-private */
        ...
        SatDatepickerInput = SatDatepickerInput_1 = __decorate([
            core.Directive({
                ...
                providers: [
                    ...
                    { provide: input.MAT_INPUT_VALUE_ACCESSOR, useExisting: SatDatepickerInput_1 },
                ],
                host: {
    ...
    var SatDatepickerToggle = /** @class */ (function () {
        ...
        __decorate([
            core.ContentChild(SatDatepickerToggleIcon, { static: false })
        ], SatDatepickerToggle.prototype, "_customIcon", void 0);
        __decorate([
            core.ViewChild('button', { static: false })
